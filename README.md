# Flickster
Codepath assignment 1. Lets users view a list of movies sourced from The Movie Database API.
...
### Notes
I had challenges with the title during this assignment. The title kept running into the image. 
